...
- Удалена библиотека компонентов shadcn и многие сопутствующие зависимости
- Множество мелких исправлений (добавление файла в чате, отображение уведомлений, убраные лишние иконки в карточках на
  главной и т. д.)

## 0.2.14 (27.11.2024)

- Изменен вид добавления файла в чате.
- Добавлена возможность добавлять текст и предлагать свою цену при отклике. В модалке с откликами добавлены новые поля.
- Обновлена база данных (возможны баги).
...
- В уведомления добавлены ссылки (пока что есть только уведомление "На ваше объявление откликнулись" и оно ведет на
  страницу созданных объявлений).
...
- При проблеме при создании объявления теперь показывается ошибка, а не перебрасывает на страницу с проблемным
  объявлением.
...
- Добавлена возможность ставить рейтинг, при завершении объявления. Рейтинг может поставить заказчик и исполнитель.
  Рейтинг показывается в профиле.
...
- Затем появляется сообщение о необходимости оплаты. После оплаты заказчик может отправить объявление на проверку
  оплаты.
